...
export default function BulkUpload({ file, onClose }: BulkUploadProps) {
  ...
  async function exportPDF() {
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.text(
        "Generated by Mederti \u00B7 mederti.vercel.app \u00B7 Data sourced from regulatory bodies worldwide",
        14, y
      );
  ...
  /* ── Render ── */
  return (
    <div className="bu-root" style={{ maxWidth: 1000, width: "100%", margin: "0 auto", padding: "24px 24px 60px", containerType: "inline-size" }}>
      ...
      {phase === "done" && (
        <>
          {/* Summary bar */}
          <div className="bu-summary" style={{
          ...
          <div style={{
            ...
            <span>
              Data sourced from regulatory bodies worldwide &middot; Updated in real-time
            </span>
            <button onClick={downloadSampleCSV} style={{
              background: "none", border: "none", cursor: "pointer",
      ...
      <style>{`
        ...
        /* Stack the summary tiles 2x2 instead of 1x4 in tight panes. */
