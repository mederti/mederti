    ...
    <section style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20, position: "relative" }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", color: "#34d399", textTransform: "uppercase" }}>
              Strategic Briefing
            </span>
            <span style={{ fontSize: 11, color: "#98a1ac" }}>·</span>
            <span style={{ fontSize: 11, color: "#98a1ac" }}>
        ...
        <button
          ...
          style={{
            ...
            background: "rgba(255,255,255,0.1)", color: "#a8b8cc",
        ...
        {data.insights.slice(0, 3).map((item, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              <div style={{ fontSize: 12, color: "#a8b8cc", lineHeight: 1.55, flex: 1 }}>
                {item.body}
              </div>
              ...
              <div style={{
                ...
                fontSize: 11, color: "#98a1ac", display: "flex", alignItems: "flex-start", gap: 6,
              }}>
                <Compass size={12} color="#34d399" style={{ marginTop: 1, flexShrink: 0 }} />
      ...
      {data.watch_list && data.watch_list.length > 0 && (
        <div style={{ paddingTop: 18, borderTop: "1px solid rgba(255,255,255,0.1)", position: "relative" }}>
          <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.08em", color: "#98a1ac", textTransform: "uppercase", marginBottom: 10, display: "flex", alignItems: "center", gap: 6 }}>
            <Clock size={11} />
      ...
      {/* Footer */}
      <div style={{ marginTop: 16, fontSize: 10, color: "#6a7280", textAlign: "right", position: "relative" }}>
