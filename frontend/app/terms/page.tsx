    ...
    <div style={{ background: "#fff", minHeight: "100vh", color: "var(--app-text)", fontFamily: "var(--font-inter), sans-serif" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", gap: 24 }}>
          <Link href="/privacy" style={{ fontSize: 13, color: "var(--app-text-3)", textDecoration: "none" }}>Privacy</Link>
  ...
  return (
    <footer style={{
      ...
      <div style={{ display: "flex", gap: 20 }}>
        ...
        <Link href="/terms" style={{ fontSize: 13, color: "var(--teal)", textDecoration: "none", fontWeight: 500 }}>Terms</Link>
