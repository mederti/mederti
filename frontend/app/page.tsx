...
const CSS = `
@import url('https://fonts.googleapis.com/css2?family=Google+Sans+Flex:wght@400..800&family=Inter:wght@400;500;600;700;800&family=DM+Mono:wght@400;500&display=swap');
...
.v1home .stat-n{font-family:'Google Sans Flex','Inter',sans-serif}
.v1home{
