 ...
 *
 * The world-atlas countries topojson (used for the MapView choropleth)
 * identifies countries by numeric ISO code; Mederti's data is keyed by
 * alpha-2 (`shortage_events.country_code` etc.). This joins the two.
 */
