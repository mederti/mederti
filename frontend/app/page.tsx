...
export default async function Home() {
  ...
  return (
    <div className="v1home">
      ...
      {/* ── Customer quotes ──
          PLACEHOLDER testimonials — swap for real, attributed quotes (with consent)
          before treating these as verified customer statements. */}
      <div className="quotes">
        <figure className="quote">
          <span className="q-mark" aria-hidden>&ldquo;</span>
          <blockquote>Mederti is the first place I check when a script can&apos;t be filled. I see the shortage, the regulator behind it, and a substitute that&apos;s actually in stock — in about ten seconds.</blockquote>
          <figcaption><span className="q-av" role="img" aria-label="Sarah R." style={{ backgroundImage: "url(https://randomuser.me/api/portraits/women/79.jpg)" }} /><span className="q-who"><b>Sarah R.</b><span>Hospital pharmacist · Melbourne</span></span></figcaption>
        </figure>
        <figure className="quote">
          <span className="q-mark" aria-hidden>&ldquo;</span>
          <blockquote>We used to chase shortage notices across half a dozen regulator sites. Now procurement gets one live picture across markets — and the supplier links have paid for themselves.</blockquote>
          <figcaption><span className="q-av" role="img" aria-label="James M." style={{ backgroundImage: "url(https://randomuser.me/api/portraits/men/45.jpg)" }} /><span className="q-who"><b>James M.</b><span>Procurement lead · NHS trust</span></span></figcaption>
        </figure>
      </div>
...
/* Customer quotes */
.quotes{max-width:1040px;margin:30px auto 0;padding:0 24px;display:grid;grid-template-columns:repeat(2,1fr);gap:20px}
.quote{position:relative;margin:0;background:var(--bg);border:1px solid var(--border);border-radius:18px;padding:30px 30px 26px;overflow:hidden}
.quote .q-mark{position:absolute;top:6px;right:24px;font-size:96px;line-height:1;font-family:Georgia,'Times New Roman',serif;font-weight:700;color:var(--green);opacity:.1;pointer-events:none}
.quote blockquote{position:relative;margin:0;font-size:16px;line-height:1.55;letter-spacing:-.018em;font-weight:500;color:var(--text)}
.quote figcaption{display:flex;align-items:center;gap:12px;margin-top:22px}
.quote .q-av{flex-shrink:0;width:48px;aspect-ratio:200/173.21;background-color:var(--bg-3);background-size:cover;background-position:center;filter:drop-shadow(0 6px 11px rgba(10,15,26,.2));-webkit-mask:url("data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20200%20173.21'%3E%3Cpath%20d='M%20187.00%2064.09%20Q%20200.00%2086.60%20187.00%20109.12%20L%20163.00%20150.69%20Q%20150.00%20173.21%20124.00%20173.21%20L%2076.00%20173.21%20Q%2050.00%20173.21%2037.00%20150.69%20L%2013.00%20109.12%20Q%200.00%2086.60%2013.00%2064.09%20L%2037.00%2022.52%20Q%2050.00%200.00%2076.00%200.00%20L%20124.00%200.00%20Q%20150.00%200.00%20163.00%2022.52%20Z'%20fill='%23000'/%3E%3C/svg%3E")center/100% 100% no-repeat;mask:url("data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20200%20173.21'%3E%3Cpath%20d='M%20187.00%2064.09%20Q%20200.00%2086.60%20187.00%20109.12%20L%20163.00%20150.69%20Q%20150.00%20173.21%20124.00%20173.21%20L%2076.00%20173.21%20Q%2050.00%20173.21%2037.00%20150.69%20L%2013.00%20109.12%20Q%200.00%2086.60%2013.00%2064.09%20L%2037.00%2022.52%20Q%2050.00%200.00%2076.00%200.00%20L%20124.00%200.00%20Q%20150.00%200.00%20163.00%2022.52%20Z'%20fill='%23000'/%3E%3C/svg%3E")center/100% 100% no-repeat}
.quote .q-who{display:flex;flex-direction:column}
.quote .q-who b{font-size:13.5px;font-weight:700;letter-spacing:-.01em;color:var(--ink)}
.quote .q-who span{font-size:12px;color:var(--text-3);margin-top:1px}
...
@media(max-width:760px){.hero h1{font-size:50px}.props{grid-template-columns:1fr;margin-top:104px;row-gap:84px}.quotes{grid-template-columns:1fr}.prop{text-align:center}.hero{padding-top:52px}.pp-sowhat{grid-template-columns:repeat(2,1fr)}.stats{grid-template-columns:1fr;gap:30px}.hero-stats{gap:10px}.hero-stats .stat-n{font-size:21px}.hero-stats .stat-l{font-size:11px}}
