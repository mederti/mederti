...
export const REPORTS: InsightCard[] = [
  {
    ...
    date: "March 2026",
    description: "Quarterly analysis of shortage trends across the markets we index, covering severity distribution, resolution timelines, and the most-affected therapeutic classes.",
