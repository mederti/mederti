...
export default function LandingContent({ countryCount, platformStats }: { countryCount: string; platformStats: PlatformStatsData }) {
    ...
    <div style={{ background: "#070B14" }}>
      ...
      <section id="how" style={{ padding: "48px 0 64px" }}>
        ...
        <div className="lp-steps-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 0, border: "1px solid rgba(255,255,255,0.1)", borderRadius: 12, overflow: "hidden" }}>
          {[
            { num: "01", title: "Collect", desc: "Daily automated scraping of regulatory bodies worldwide \u2014 TGA, FDA, MHRA, EMA, Health Canada, PMDA and more across major markets." },
          ...
          <div style={{
            ...
            <div style={{ padding: "0 16px 16px" }}>
              <div style={{ fontSize: 12, color: "rgba(255,255,255,0.5)", lineHeight: 1.8, padding: "12px 0", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
                <strong style={{ color: "rgba(255,255,255,0.7)" }}>This week across the markets we index:</strong> 5 new shortages declared {"\u00B7"} 2 resolved {"\u00B7"} Antibiotic category now at highest severity since 2023.
              </div>
              {[
